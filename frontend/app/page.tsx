...
export default function Home() {
  return (
    <section className="relative w-full min-h-dvh flex items-center justify-center overflow-hidden">
      ...
      {/* Contenido del Hero */}
      <div className="relative z-10 flex flex-col items-center text-center gap-6 px-5 py-16 max-w-3xl sm:gap-7 md:gap-8">
        ...
        <p className="text-lg text-white/75 max-w-xl leading-relaxed font-light opacity-0 animate-fade-in-up [animation-delay:150ms] sm:text-xl">
        ...
        <div className="flex flex-col gap-3.5 w-full max-w-xs mt-2 opacity-0 animate-fade-in-up [animation-delay:300ms] sm:flex-row sm:max-w-none sm:w-auto">
          <Link
            href="/propiedades"
            className="group inline-flex items-center justify-center gap-2 rounded-lg bg-orange-500 px-7 py-3.5 text-base font-semibold text-white transition-all duration-300 hover:bg-indigo-400 hover:shadow-xl hover:shadow-indigo-500/25 hover:-translate-y-0.5 active:scale-[0.98]"
          >
